...
class PseudoAgenteTaller:
   ...
   def operacion(self, num1: int, num2: int, signo: str):
    """
    Realiza operaciones aritméticas básicas entre dos números.
    
    Args:
        num1 (int): El primer operando.
        num2 (int): El segundo operando.
        signo (str): El operador (+, -, *, /).
        
    Returns:
        int/float/str: El resultado de la operación o un mensaje de error.
    """
    if signo == '+':
        resultado = num1 + num2
    elif signo == '-':
    ...
    mi_agente =  Pseudoagente = Pseudoagente("Athena") 
    print(f"[{mi_agente.nombre}] tokes ava {mi_agente.tokens}")
